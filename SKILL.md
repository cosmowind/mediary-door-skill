...
```bash
# 基础 URL
# dev 环境：https://your-dev-domain.com/api/v1  （后端端口 9000）
# 生产环境：https://your-domain.com/api/v1  （后端端口 8081）
BASE_URL="https://your-dev-domain.com/api/v1"
...
curl -s -H "Authorization: Bearer YOUR_API_KEY" \
  https://your-dev-domain.com/api/v1/tags | jq .
```
